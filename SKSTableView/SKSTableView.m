...
- (void)setSKSTableViewDelegate:(id<SKSTableViewDelegate>)SKSTableViewDelegate
{
    ...
    if (SKSTableViewDelegate) _SKSTableViewDelegate = SKSTableViewDelegate;
}
...
- (NSMutableDictionary *)expandableCells
{
    if (!_expandableCells)
    {
        ...
        {
            NSInteger numberOfRowsInSection = [self.SKSTableViewDelegate tableView:self numberOfRowsInSection:section];
            NSMutableArray *rows = [NSMutableArray array];
            for (NSInteger row = 0; row < numberOfRowsInSection; row++)
            {
                NSIndexPath *rowIndexPath = [NSIndexPath indexPathForRow:row inSection:section];
                NSInteger numberOfSubrows = [self.SKSTableViewDelegate tableView:self numberOfSubRowsAtIndexPath:rowIndexPath];
...
{
    if ([_SKSTableViewDelegate respondsToSelector:@selector(tableView:titleForHeaderInSection:)]) return [_SKSTableViewDelegate tableView:tableView titleForHeaderInSection:section];
    return nil;
}

- (NSString *)tableView:(UITableView *)tableView titleForFooterInSection:(NSInteger)section
{
    if ([_SKSTableViewDelegate respondsToSelector:@selector(tableView:titleForFooterInSection:)]) return [_SKSTableViewDelegate tableView:tableView titleForFooterInSection:section];
    return nil;
}
...
{
    NSIndexPath *correspondingIndexPath = [self correspondingIndexPathForRowAtIndexPath:indexPath];
    if ([_SKSTableViewDelegate respondsToSelector:@selector(tableView:canEditRowAtIndexPath:)]) return [_SKSTableViewDelegate tableView:tableView canEditRowAtIndexPath:correspondingIndexPath];
    return NO;
}
...
{
    NSIndexPath *correspondingIndexPath = [self correspondingIndexPathForRowAtIndexPath:indexPath];
    if ([_SKSTableViewDelegate respondsToSelector:@selector(tableView:canMoveRowAtIndexPath:)]) return [_SKSTableViewDelegate tableView:tableView canMoveRowAtIndexPath:correspondingIndexPath];
    return NO;
}

- (NSArray *)sectionIndexTitlesForTableView:(UITableView *)tableView
{
    if ([_SKSTableViewDelegate respondsToSelector:@selector(sectionIndexTitlesForTableView:)]) return [_SKSTableViewDelegate sectionIndexTitlesForTableView:tableView];
    return nil;
}
...
- (void)tableView:(UITableView *)tableView commitEditingStyle:(UITableViewCellEditingStyle)editingStyle forRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([_SKSTableViewDelegate respondsToSelector:@selector(tableView:commitEditingStyle:forRowAtIndexPath:)])
        [_SKSTableViewDelegate tableView:tableView commitEditingStyle:editingStyle forRowAtIndexPath:correspondingIndexPath];
}
...
- (void)tableView:(UITableView *)tableView willDisplayCell:(UITableViewCell *)cell forRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([_SKSTableViewDelegate respondsToSelector:@selector(tableView:willDisplayCell:forRowAtIndexPath:)])
        [_SKSTableViewDelegate tableView:tableView willDisplayCell:cell forRowAtIndexPath:correspondingIndexPath];
}
...
- (void)tableView:(UITableView *)tableView didEndDisplayingCell:(UITableViewCell *)cell forRowAtIndexPath:(NSIndexPath*)indexPath
{
    ...
    if ([_SKSTableViewDelegate respondsToSelector:@selector(tableView:didEndDisplayingCell:forRowAtIndexPath:)])
        [_SKSTableViewDelegate tableView:tableView didEndDisplayingCell:cell forRowAtIndexPath:correspondingIndexPath];
}
...
//        return [_SKSTableViewDelegate tableView:tableView estimatedHeightForRowAtIndexPath:correspondingIndexPath];
//
//    return 0;
//}
//
...
//        return [_SKSTableViewDelegate tableView:tableView estimatedHeightForHeaderInSection:section];
//
//    return 0;
//}
//
...
- (BOOL)tableView:(UITableView *)tableView shouldHighlightRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([_SKSTableViewDelegate respondsToSelector:@selector(tableView:shouldHighlightRowAtIndexPath:)])
        return [_SKSTableViewDelegate tableView:tableView shouldHighlightRowAtIndexPath:correspondingIndexPath];
    return YES;
}
...
//        [_SKSTableViewDelegate tableView:tableView didHighlightRowAtIndexPath:correspondingIndexPath];
//}
//
...
//        [_SKSTableViewDelegate tableView:tableView didUnhighlightRowAtIndexPath:correspondingIndexPath];
//}
...
- (NSIndexPath *)tableView:(UITableView *)tableView willSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([_SKSTableViewDelegate respondsToSelector:@selector(tableView:willSelectRowAtIndexPath:)])
        return [_SKSTableViewDelegate tableView:tableView willSelectRowAtIndexPath:correspondingIndexPath];
    return indexPath;
}
...
- (NSIndexPath *)tableView:(UITableView *)tableView willDeselectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([_SKSTableViewDelegate respondsToSelector:@selector(tableView:willDeselectRowAtIndexPath:)])
        return [_SKSTableViewDelegate tableView:tableView willDeselectRowAtIndexPath:correspondingIndexPath];
    return indexPath;
}
...
- (void)tableView:(UITableView *)tableView didDeselectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([_SKSTableViewDelegate respondsToSelector:@selector(tableView:didDeselectRowAtIndexPath:)])
        [_SKSTableViewDelegate tableView:tableView didDeselectRowAtIndexPath:correspondingIndexPath];
}
...
- (UITableViewCellEditingStyle)tableView:(UITableView *)tableView editingStyleForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([_SKSTableViewDelegate respondsToSelector:@selector(tableView:editingStyleForRowAtIndexPath:)])
        return [_SKSTableViewDelegate tableView:tableView editingStyleForRowAtIndexPath:correspondingIndexPath];
...
{
    NSIndexPath *correspondingIndexPath = [self correspondingIndexPathForRowAtIndexPath:indexPath];
    if ([_SKSTableViewDelegate respondsToSelector:@selector(tableView:editActionsForRowAtIndexPath:)])
        return [_SKSTableViewDelegate tableView:tableView editActionsForRowAtIndexPath:correspondingIndexPath];
    return nil;
}
...
- (NSString *)tableView:(UITableView *)tableView titleForDeleteConfirmationButtonForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([_SKSTableViewDelegate respondsToSelector:@selector(tableView:titleForDeleteConfirmationButtonForRowAtIndexPath:)])
        return [_SKSTableViewDelegate tableView:tableView titleForDeleteConfirmationButtonForRowAtIndexPath:correspondingIndexPath];
    return nil;
}
...
- (BOOL)tableView:(UITableView *)tableView shouldIndentWhileEditingRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([_SKSTableViewDelegate respondsToSelector:@selector(tableView:shouldIndentWhileEditingRowAtIndexPath:)])
        return [_SKSTableViewDelegate tableView:tableView shouldIndentWhileEditingRowAtIndexPath:correspondingIndexPath];
    return NO;
}
...
- (void)tableView:(UITableView*)tableView willBeginEditingRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([_SKSTableViewDelegate respondsToSelector:@selector(tableView:willBeginEditingRowAtIndexPath:)])
        [_SKSTableViewDelegate tableView:tableView willBeginEditingRowAtIndexPath:correspondingIndexPath];
}
...
- (void)tableView:(UITableView*)tableView didEndEditingRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([_SKSTableViewDelegate respondsToSelector:@selector(tableView:didEndEditingRowAtIndexPath:)])
        [_SKSTableViewDelegate tableView:tableView didEndEditingRowAtIndexPath:correspondingIndexPath];
}
    ...
    [self.expandableCells enumerateKeysAndObjectsUsingBlock:^(id key, id obj, BOOL *stop) {
        ...
        [obj enumerateObjectsUsingBlock:^(id obj, NSUInteger idx, BOOL *stop) {
            ...
            if (isExpanded)
            {
                ...
                {
                    NSIndexPath *expandedIndexPath = [NSIndexPath indexPathForRow:currentRow + index inSection:[key integerValue]];
...
- (void)collapseCurrentlyExpandedIndexPaths2
{
    NSMutableArray *totalExpandedIndexPaths = [NSMutableArray array];
    NSMutableArray *totalExpandableIndexPaths = [NSMutableArray array];
    [self.expandableCells enumerateKeysAndObjectsUsingBlock:^(id key, id obj, BOOL *stop) {
        ...
        [obj enumerateObjectsUsingBlock:^(id obj, NSUInteger idx, BOOL *stop) {
            NSInteger currentRow = idx + totalExpandedSubrows;
            BOOL isExpanded = [obj[kIsExpandedKey] boolValue];
            NSUInteger subrowCount = [obj[kSubrowsKey] integerValue];
            if (isExpanded && subrowCount > 0)
            {
                NSInteger expandedSubrows = [obj[kSubrowsKey] integerValue];
                for (NSInteger index = 1; index <= expandedSubrows; index++)
                {
    ...
    {
        SKSTableViewCell *cell = (SKSTableViewCell *)[self cellForRowAtIndexPath:indexPath];
        if ([cell respondsToSelector:@selector(isExpandable)] && cell.isExpandable) {
            cell.expanded = NO;
            [cell accessoryViewAnimation];
        }
    }
...
{
    if (indexPaths == nil || indexPaths.count == 0) return;
    NSMutableSet<NSIndexPath *> *toBeDeletedRowsIndexPath = [NSMutableSet new];
    for (NSIndexPath *indexPath in indexPaths)
    {
        NSIndexPath *originIndexPath = [self originalIndexPathForCustomIndexPath:indexPath];
        [toBeDeletedRowsIndexPath addObject:[self originalIndexPathForCustomIndexPath:indexPath]];
        if (indexPath.subRow == 0)
        {
            NSMutableDictionary *cellInfo = self.expandableCells[@(indexPath.section)][indexPath.row];
            if ([cellInfo[kIsExpandedKey] boolValue])
            {
                for (int i=0; i< [self.expandableCells[@(indexPath.section)][indexPath.row][kSubrowsKey] integerValue];i++)
                {
                    [toBeDeletedRowsIndexPath addObject:[NSIndexPath indexPathForRow:originIndexPath.row + i + 1 inSection:originIndexPath.section]];
                }
            }
            [self.expandableCells[@(indexPath.section)] removeObjectAtIndex:indexPath.row];
        }
        else
        {
            [toBeDeletedRowsIndexPath addObject:[self originalIndexPathForCustomIndexPath:indexPath]];
            NSUInteger subrowCount = [self.expandableCells[@(indexPath.section)][indexPath.row][kSubrowsKey] integerValue];
            subrowCount--;
            [self.expandableCells[@(indexPath.section)][indexPath.row] setObject:@(subrowCount) forKey:kSubrowsKey];
            if (subrowCount == 0)
            {
                [self.expandableCells[@(indexPath.section)][indexPath.row] setObject:@(NO) forKey:kIsExpandedKey];
                NSIndexPath *originalIndexPath = [self originalIndexPathForCustomIndexPath:[NSIndexPath indexPathForSubRow:0 inRow:indexPath.row inSection:indexPath.section]];
                [self deleteRowsAtIndexPaths:[toBeDeletedRowsIndexPath allObjects] withRowAnimation:animation];
                [self reloadRowsAtIndexPaths:@[originalIndexPath] withRowAnimation:UITableViewRowAnimationNone];
                return;
            }
        }
    }
...
//transfer corresponding indexPath to UITableView IndexPath
- (NSIndexPath *)originalIndexPathForCustomIndexPath:(NSIndexPath *)indexPath
{
    __block NSIndexPath *originalIndexPath = nil;
    __block NSInteger expandedSubrows = 0;
    NSArray *rows = self.expandableCells[@(indexPath.section)];
    [rows enumerateObjectsUsingBlock:^(id  _Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop)
     {
         ...
         if (isExpanded)
         {
             numberOfSubrows = [self numberOfSubRowsAtIndexPath:[NSIndexPath indexPathForRow:idx inSection:indexPath.section]];
         }
         ...
         {
             originalIndexPath = [NSIndexPath indexPathForRow:indexPath.row + indexPath.subRow + expandedSubrows inSection:indexPath.section];
             *stop = YES;
         }
     }];
...
- (BOOL)isEqual:(id)object
{
    ...
    return indexPath.section == self.section && indexPath.row == self.row && indexPath.subRow == self.subRow;
}
